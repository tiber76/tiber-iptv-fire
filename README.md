...
3. Telecharger l'APK `tiber-iptv-0.3.9-42-release.apk`.
...
adb install -r app/build/outputs/apk/release/tiber-iptv-0.3.9-42-release.apk
```
...
```text
app/build/outputs/apk/debug/tiber-iptv-0.3.9-42-debug.apk
```
