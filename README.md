...
3. Telecharger l'APK `tiber-iptv-0.3.8-41-release.apk`.
...
adb install -r app/build/outputs/apk/release/tiber-iptv-0.3.8-41-release.apk
```
...
```text
app/build/outputs/apk/debug/tiber-iptv-0.3.8-41-debug.apk
```
